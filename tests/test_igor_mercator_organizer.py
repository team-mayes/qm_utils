...
class TestIgorMercator(unittest.TestCase):
    def testReadingAllInputFiles(self):
        method, job_type, sort_status, dict = reading_all_csv_input_files(OXANE_AM1_LM_UNSORTED)
    ...
    def testCreatingDataDict(self):
        ...
        print('/Users/vicchio/code/python/qm_utils/tests/test_data/igor_mercator')
        output_filename = create_out_fname('igor_df_oxane_am1', base_dir=SUB_DATA_DIR, ext='.csv')
        print(output_filename)
        write_file_data_dict(data_dict,output_filename)

class TestMain(unittest.TestCase):
    def testMain(self):
        test_input = [ "-raw_lm", OXANE_AM1_LM_UNSORTED,
