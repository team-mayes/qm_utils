...
# Input files #
HSP_LOCAL_MIN_BXYL = 'z_bxyl_lm-b3lyp_howsugarspucker.csv'
HSP_TRANS_STA_BXYL = 'z_bxyl_TS-b3lyp_howsugarspucker.csv'
HSP_LOCAL_MIN_OXANE= 'z_oxane_lm-b3lyp_howsugarspucker.csv'
HSP_TRANS_MIN_OXANE= 'hi'
...
number_clusters = 8
data_points, phi_raw, theta_raw, energy = read_csv_data(HSP_LOCAL_MIN_OXANE, TEST_DIR)
...
data.plot_all_vor_sec()
data.plot_local_min_sizes()
...
#         storage_spot = LOCAL_MIN_IMAGES
#         number_clusters = 9
#         data_points, phi_raw, theta_raw, energy = read_csv_data(HSP_LOCAL_MIN_BXYL, SUB_DATA_DIR)
...
# # # # Transition States # # #
# number_clusters = 9
# data_points, phi_raw, theta_raw, energy = read_csv_data(HSP_LOCAL_MIN_BXYL, TEST_DIR)
# dict_cano = read_csv_canonical_designations('CP_params.csv', TEST_DIR)
# data = Local_Minima(number_clusters, data_points, dict_cano, phi_raw, theta_raw, energy)
# try:
#     save_status = False
...
#     data_points_ts, phi_raw_ts, theta_raw_ts, data_dict_ts = read_csv_data_TS(HSP_TRANS_STA_BXYL, TEST_DIR)
#
# finally:
